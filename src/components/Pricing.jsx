  ...
  return (
    ...
    >
      ...
      <div className="p-6 flex flex-col flex-1">
        ...
        <p className="text-xs text-muted-foreground mt-1 flex-1">{service.desc}</p>
        ...
        <button className="liquid-glass rounded-full border border-primary/40 py-2 text-xs font-medium mt-4 transition-transform duration-200 hover:scale-105">
          Get Started
        </button>
      </div>
    </div>
