...
function Navbar() {
  ...
  return (
    <nav
      ...
      style={{ background: scrolled ? undefined : 'transparent', backdropFilter: scrolled ? undefined : 'none' }}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-6 flex flex-row justify-between items-center gap-2">
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          <button className="liquid-glass animate-glow-pulse rounded-full px-4 sm:px-5 py-2 text-xs sm:text-sm border border-primary/40 text-foreground transition-transform duration-200 hover:scale-105 whitespace-nowrap">
            Call Us
          </button>
        ...
        <>
          ...
          >
            ...
            <div className="px-6 mt-auto mb-8">
              <button
                onClick={() => setMenuOpen(false)}
                className="liquid-glass animate-glow-pulse rounded-full w-full py-3 text-sm border border-primary/40 text-foreground"
              >
                Call Us
              </button>
            </div>
