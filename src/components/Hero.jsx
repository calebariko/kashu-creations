    ...
    >
      ...
      >
        ...
        <div ref={subtextParallax} className="animate-fade-rise-delay-2 mt-6">
          ...
          >
            Let us create something extraordinary together. We design and print
            custom branding for apparel and every material you can put a brand
            on — from first sketch to finished product.
          </p>
        </div>

        <div
          ref={ctaParallax}
          className="animate-fade-rise-delay-3 mt-10 flex items-center gap-6 flex-wrap justify-center"
        >
          <a
            href={whatsappLink(
              "Hi, I'd like to start an order with Kashu Creations.",
            )}
            target="_blank"
            rel="noopener noreferrer"
            className="liquid-glass animate-glow-pulse rounded-full border border-primary/40 px-8 py-4 text-sm font-medium transition-transform duration-200 hover:scale-105 inline-block"
          >
            Start Your Order
          </a>
          <a
            href="#process"
            className="text-muted-foreground text-sm hover:underline transition-colors duration-200"
          >
            See how it works →
          </a>
        </div>
